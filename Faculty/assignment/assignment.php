...
<?php include 'nav-header.php';
 ...
 <section id="main-content">
 	...
 	<div class="row" style="padding-top: 90px;padding-left: 20px;">
      ...
      echo '<tr>
               <td> <a href="listassignment.php?id='.$data3->Subject_Code.'&dept='.$id.'">'.$data3->Subject_name.'</a></td>
                <td>'.$data1->Class_name.'</td>
                <td>'.$data2->Name.'</td>
                <td><a href="uploadAssignment.php?sub='.$row['Subject_Code'].'&dept='.$id.'">'.'Upload'.'</a></td>
