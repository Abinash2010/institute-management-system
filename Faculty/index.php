...
<section id="main-content">
  ...
  <?php  echo '<a href="faculty/faculty.php?dept='.$data->Dept_id.'"><div class="card1">'; ?>
        <center><h2 class="cardtxt">Faculty</h2></center>
      </div></a><br/>
    </div>
    <div class="col-lg-3 col-md-6 col-xs-12">
 <?php  echo'<a href="student/student.php?dept='.$data->Dept_id.'">  <div class="card2">'; ?>
        <center><h2 class="cardtxt">Student</h2></center>
      </div></a><br/>
    </div>
    <div class="  col-lg-3 col-md-6 col-xs-12">
      <?php  echo '<a href="department/department.php?dept='.$data->Dept_id.'"><div class="card3">'; ?>
