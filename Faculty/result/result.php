...
<?php include 'nav-header.php';
 ...
 <?php echo '<a href="class.php?dept='.$id.'" class="btn btn-success" style="float: right;margin-right: 50px;">'.'SGPA'.'</a>'; ?>
      ...
      echo '<tr>
               <td> <a href="listexam.php?sub='.$data3->Subject_Code.'&dept='.$id.'">'.$data3->Subject_name.'</a></td>
                ...
                <td>'.$data2->Name.'</td>
                <td><a href="selectexam.php?sub='.$row['Subject_Code'].'&dept='.$id.'">'.'Upload'.'</a></td>
