 ...
 <section id="main-content">
 	...
 	<div class="row" style="padding-top: 90px;">
 		...
 		<?php
 			if($data->File_Name!='')
 			{
 					echo '<br/><br/><a href="../../Assignment/'.$data->File_Name.'" download>'.'Download The File'.'</a><br/><br/>'; 
 				
 			}
 					echo '<h3>'.'Date       :'.$data->Date.'</h3>';
 					echo '<h3>'.'Due Date   :'.$data->Due_date.'</h3>';
 					 echo '<a style="float:right;margin-top:-30px;" href="whosubmit.php?id='.$assignment_id.'">'.'Assignment done by'.'</a>';
 		?>
 	</div>
