...
<?php include 'nav-header.php';
 ...
 <div style="padding-top: 100px;">
      ...
      echo '<tr>
               <td> <a href="listexam.php?id='.$data3->Subject_Code.'">'.$data3->Subject_name.'</a></td>
                <td>'.$data1->Class_name.'</td>
                <td>'.$data2->Name.'</td>
                <td><a href="uploadresult.php?cls='.$id.'&dept='.$dept.'&sub='.$row['Subject_Code'].'" class="btn btn-primary">'.'Upload'.'</a></td>
