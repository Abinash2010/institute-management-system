 ...
 <?php
  foreach($data as $box)
  {
    echo '<tr><td>'.$box['Class_name'].'</td>
                <td><a href="listsubject.php?class='.$box['Class_Code'].'&dept='.$id.'" class="btn btn-info">'.'View'.'</a>
                 <a href="graderesult.php?class='.$box['Class_Code'].'&dept='.$id.'" class="btn btn-success">'.'View Grade'.'</a>
                  </td>
                </tr>';
    }
 ?>
