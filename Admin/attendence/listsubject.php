...
<?php include 'nav-header.php';
 ...
 <div style="padding-top: 100px;">
    ...
    <table class="table table-bordered-primary">
      ...
      echo '<tr>
               <td> <a href="viewattendence.php?id='.$data3->Subject_Code.'&dept='.$dept.'&cls='.$id.'">'.$data3->Subject_name.'</a></td>
                <td>'.$data1->Class_name.'</td>
                <td>'.$data2->Name.'</td>
                 <td><a href="uploadAttendence.php?sub='.$data3->Subject_Code.'&dept='.$dept.'&cls='.$id.'">'.'Upload'.'</td>
