...
$sql2->bindParam(':dis',$id,PDO::PARAM_STR);
$sql2->execute();
...
<?php include 'nav-header.php';
 ...
 <tr>
          ...
          foreach($data3 as $rows1)
          {
           ...
           $sql4=$db->prepare("SELECT * FROM `Attendence_student` where Student_id=:std and Attendence_id=:aid");
            $sql4->bindParam(':std',$rows1['Student_id'],PDO::PARAM_STR);
             $sql4->bindParam(':aid',$data2->Attendence_id,PDO::PARAM_STR);
            $sql4->execute();
